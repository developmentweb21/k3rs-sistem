<div id="app-container">
    ...
    <aside id="desktop-sidebar" class="glass-sidebar sidebar fixed h-full text-white flex flex-col justify-between">
        <div>
            ...
            <div class="sidebar-user"><span class="sidebar-avatar"><i class="fa-solid fa-user"></i></span>
                <div>
                    <p id="sidebar-user-name">Pengguna</p><small id="sidebar-user-role">USER</small>
                </div>
            </div>
